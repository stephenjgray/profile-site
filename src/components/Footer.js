    ...
    <div className="footer" style={{ backgroundColor: "#59759b" }}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid className={props.classes.social} container item xs={12} sm={6}>
          <Button href={props.urls.linkedIn} target="_blank" rel="noreferrer">
            <LinkedInIcon style={{ color: "white" }} />
          </Button>
          <Button href={props.urls.twitter}  target="_blank" rel="noreferrer">
            <TwitterIcon style={{ color: "white" }} />
          </Button>
          <Button href={props.urls.gitHub} target="_blank" rel="noreferrer">
